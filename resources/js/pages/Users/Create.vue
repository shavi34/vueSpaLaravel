            ...
            <div class="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
                <form class="space-y-6" @submit.prevent="submit">
                    <div>
                        ...
                        <div class="mt-1">
                            <input id="email" name="name" type="text" autocomplete="text" required v-model="form.name"
                    ...
                    <div>
                        ...
                        <div class="mt-1">
                            <input id="title" name="title" type="text" autocomplete="text" required v-model="form.title"
                                   class="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                        </div>
                    </div>
                    <div>
                        ...
                        <div class="mt-1">
                            <input id="company" name="company" type="text" autocomplete="text" required v-model="form.company"
                                   class="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                        </div>
                    </div>
                    <div>
                        ...
                        <div class="mt-1">
                            <input id="role" name="role" type="text" autocomplete="text" required v-model="form.role"
                                   class="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                        </div>
                    </div>
                    <div>
                        ...
                        <div class="mt-1">
                            <input id="phone" name="phone" type="number" autocomplete="text" required v-model="form.phone"
                                   class="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                        </div>
                    </div>
                    <div>
